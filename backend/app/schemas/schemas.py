...
class BusinessRuleSchema(BaseModel):
    ...
    workflow_code: Optional[str] = None
    conditions_json: Optional[Union[str, list, dict]] = '[]'
    conditions: Optional[Union[str, list, dict]] = None
    description: Optional[str] = None
    rule_action: Optional[str] = 'WORKFLOW_ROUTE'
    cancel_reason: Optional[str] = None
    auto_approve_enabled: Optional[bool] = False
...
class NotificationTestSchema(BaseModel):
    to: str
    subject: Optional[str] = "DocuFlow System Notification Test"
    html: Optional[str] = "<p>SMTP Test Email</p>"
