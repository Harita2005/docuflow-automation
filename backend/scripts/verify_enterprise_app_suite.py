...
try:
    ...
    test_cases = [{'name': 'Enterprise IT Capex Sync', 'req': DocumentSyncRequest(doc_key='TEST-SUITE-DOC-901', company_code='VCC', division='VCC', document_type='AP INVOICE', category='Freight Charges', cost_center='DIGITAL MARKETING', plant='TN-ERODE-PERUNDURAI ROAD', amount=75000.0, vendor_code='VEND-901', vendor_name='Perundurai Logistics Ltd', pay_mode='BANK')}, {'name': 'Accessories & Hardware Asset Purchase', 'req': DocumentSyncRequest(doc_key='TEST-SUITE-DOC-902', company_code='ACC', division='ACC', document_type='AP INVOICE', category='ACCESSORIES - COMPUTER', cost_center='Office Maintenance', plant='ATITHYA-EXCISE', amount=125000.0, vendor_code='VEND-902', vendor_name='Dell Enterprise Hardware', pay_mode='BANK')}]
