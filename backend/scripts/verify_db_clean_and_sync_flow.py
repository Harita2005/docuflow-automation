...
from app.models import User, Document, DocumentLineItem, WorkflowProfile, WorkflowStepDefinition, BusinessRule, ChecklistTemplate, DocumentChecklistState, DocumentApprovalLog
...
def verify_all():
    ...
    test_cases = [{'name': 'VCC Freight Invoice', 'payload': DocumentSyncRequest(doc_key='TEST-SYNC-101', division='VCC', category='Freight Charges', cost_center='DIGITAL MARKETING', plant='TN-ERODE-PERUNDURAI ROAD', vendor_name='TNT Logistics Ltd', vendor_code='VEND-TNT-01', invoice_number='INV-TNT-991', invoice_date='2026-09-04', amount=75000.0, auto_route=True)}, {'name': 'ACC Asset Purchase', 'payload': DocumentSyncRequest(doc_key='TEST-SYNC-102', division='ACC', category='ACCESSORIES - COMPUTER', cost_center='Office Maintenance', plant='ATITHYA-EXCISE', vendor_name='Dell Technologies', vendor_code='VEND-DELL-88', invoice_number='INV-DELL-204', invoice_date='2026-09-04', amount=150000.0, auto_route=True)}, {'name': 'ATC Machinery Purchase', 'payload': DocumentSyncRequest(doc_key='TEST-SYNC-103', division='ATC', category='MACHINERY', cost_center='PRODUCTION TABLE', plant='BHAVANI', vendor_name='LMW Textile Machinery', vendor_code='VEND-LMW-09', invoice_number='INV-LMW-701', invoice_date='2026-09-04', amount=450000.0, auto_route=True)}, {'name': 'RRF Utility & Rent', 'payload': DocumentSyncRequest(doc_key='TEST-SYNC-104', division='RRF', category='RENT', cost_center='BUILDING MAINTENANCE', plant='TN-CHENNAI-T-NAGAR', vendor_name='Commercial Property Real Estate', vendor_code='VEND-PROP-11', invoice_number='INV-RENT-802', invoice_date='2026-09-04', amount=120000.0, auto_route=True)}, {'name': 'E-Voucher Cash Flow', 'payload': DocumentSyncRequest(doc_key='TEST-SYNC-105', division='VCC', category='PETTY CASH', cost_center='ADMINISTRATION', plant='TN-SIVAKASI', vendor_name='Local Office Supplies', vendor_code='VEND-SUPP-04', invoice_number='EV-CASH-301', invoice_date='2026-09-04', amount=12500.0, auto_route=True)}]
    print('\n' + '=' * 80)
