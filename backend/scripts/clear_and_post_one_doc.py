...
doc_id = 'DOC-VCC-001'
one_doc = Document(id=doc_id, doc_key='DOC-VCC-001', doc_num='INV-VCC-2026-001', doc_date=datetime.date.today().strftime('%Y-%m-%d'), party_name='LAKSHMI MACHINE WORKS LTD', vendor_name='LAKSHMI MACHINE WORKS LTD', invoice_number='INV-VCC-2026-001', amount=50000.0, base_amount=45000.0, tax_amount=5000.0, currency='INR', document_type='AP INVOICE', division='VCC', cost_center='Finance & Admin', category='Vendor Payment Workflows', status='Pending Approval', current_stage=1, created_at=datetime.datetime.utcnow())
db.add(one_doc)
db.commit()
