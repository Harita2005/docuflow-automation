...
db = SessionLocal()
try:
    req = DocumentSyncRequest(company_code='VCC', division='VCC', invoice_number='INV-VCC-BV-2026-001', doc_key='DOC-VCC-BV-001', document_type='AP INVOICE', category='VEHICLE & FLEET MAINTENANCE', cost_center='BATTERY VEHICLE', plant='TN-ERODE-PERUNDURAI ROAD', amount=45000.0, tax_amount=8100.0, base_amount=36900.0, vendor_code='VEND-EV-501', vendor_name='Eco Drive EV Fleet Services', pay_mode='BANK')
